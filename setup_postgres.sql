...
CREATE INDEX IF NOT EXISTS idx_quiz_submissions_status ON quiz_submissions(quiz_id, grading_status);
CREATE INDEX IF NOT EXISTS idx_quiz_submissions_publish_state ON quiz_submissions(quiz_id, is_result_published);
CREATE INDEX IF NOT EXISTS idx_quiz_submissions_graded_by ON quiz_submissions(graded_by);
-- ============================================
-- FLASHCARDS
-- ============================================
