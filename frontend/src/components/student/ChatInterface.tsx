                        ...
                        <div className="flex flex-col items-center justify-center h-full text-center text-muted-foreground space-y-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm max-w-md mx-auto mt-1">
                                    Ask me anything about <span className="font-medium text-foreground">{selectedCourse?.name || "your course"}</span>.
                        ...
                        messages.map((msg, idx) => (
                            ...
                            >
                                <div className={cn(
                                    ...
                                    msg.role === 'user' ? "bg-muted" : "bg-green-100 text-green-600 dark:bg-emerald-950/40 dark:text-emerald-300"
                                )}>
