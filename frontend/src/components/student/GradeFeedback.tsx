            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
              <div className="bg-white rounded-lg sm:rounded-xl shadow p-4 sm:p-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Graded</p>
                    <p className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">{stats?.total_graded || 0}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg sm:rounded-xl shadow p-4 sm:p-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Average</p>
                    ...
                    {selectedAssignment?.id === assignment.id && assignment.feedback && (
                      <div className="border-t border-gray-200 dark:border-gray-700 p-4 sm:p-6 bg-gray-50">
                        <div className="flex items-start gap-3 mb-3">
                          ...
                          <h4 className="font-semibold text-gray-900 dark:text-white">Instructor Feedback</h4>
                        </div>
                        <div className="prose prose-sm max-w-none text-gray-700 dark:text-gray-300 break-words whitespace-pre-wrap">
                          {assignment.feedback}
                        </div>
                      </div>
                    )}
