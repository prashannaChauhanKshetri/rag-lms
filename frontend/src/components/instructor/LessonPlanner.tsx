...
export function LessonPlanner() {
    ...
    return (
        <div className="flex h-full gap-6">
            ...
            <div className="w-1/3 bg-white dark:bg-gray-900 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 flex flex-col h-full">
                ...
                <form onSubmit={handleGenerate} className="space-y-6 flex-1">
                    <div>
                        ...
                        <select
                            ...
                            className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500 outline-none bg-white dark:bg-gray-900"
            ...
            <div className="flex-1 bg-white dark:bg-gray-900 p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 flex flex-col h-full overflow-hidden">
                <div className="flex justify-between items-center mb-6 pb-4 border-b">
                    <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100">Lesson Plan Preview</h2>
                    {lessonPlan && (
                        <button
                            onClick={handleSave}
                ...
                <div className="flex-1 overflow-y-auto pr-2">
                    {!lessonPlan ? (
                        ...
                        <article className="prose prose-sm md:prose-base max-w-none text-gray-800 dark:text-gray-100">
